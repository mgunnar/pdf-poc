...
function App() {
  const [profile, setProfile] = useState({
    ...
    endJobDate: 'Present',
    jobDescription: "During the internship I got training in Typescript, React and Node.js. I also received training using Agile Methodologies and the Git Flow.",
    ...
    projectDescription: "This project was carried out in my first and second semester of the Bachelor's  Degree in Computer Science at Centro Universitário Cesuca, with the objective  of identifying the knowledge of IT and legal professionals about LGPD in order  to understand how they interpret the law and the apply in your personal or  work context.",
  });
